...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _getForecast__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getForecast */ \"./src/getForecast.js\");\n/* harmony import */ var _getWeatherInfo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getWeatherInfo */ \"./src/getWeatherInfo.js\");\n\n\n\nconst submitBtn = document.getElementById('submit');\nconst input = document.getElementById('input');\nconst chkBox = document.querySelector(\"input[name=checkbox]\");\n\nchkBox.addEventListener('change', function () {\n    let currentCity;\n\n    if(input.value === '') {\n        currentCity = 'reno'\n    } else {\n        currentCity = input.value.trim()\n    }\n\n    if(this.checked) {\n        (0,_getWeatherInfo__WEBPACK_IMPORTED_MODULE_1__.getWeatherInfo)(currentCity, 'metric');\n        (0,_getForecast__WEBPACK_IMPORTED_MODULE_0__.getForecast)(currentCity, 'metric')\n    } else {\n        (0,_getWeatherInfo__WEBPACK_IMPORTED_MODULE_1__.getWeatherInfo)(currentCity, 'imperial');\n        (0,_getForecast__WEBPACK_IMPORTED_MODULE_0__.getForecast)(currentCity, 'imperial');\n    }\n})\n\n\nsubmitBtn.addEventListener('click', () => {\n    if(!chkBox.checked) {\n        (0,_getWeatherInfo__WEBPACK_IMPORTED_MODULE_1__.getWeatherInfo)(input.value.trim(), 'imperial');\n        (0,_getForecast__WEBPACK_IMPORTED_MODULE_0__.getForecast)(input.value.trim(), 'imperial');\n    } else if (chkBox.checked) {\n        (0,_getWeatherInfo__WEBPACK_IMPORTED_MODULE_1__.getWeatherInfo)(input.value.trim(), 'metric');\n        (0,_getForecast__WEBPACK_IMPORTED_MODULE_0__.getForecast)(input.value.trim(), 'metric');\n    }\n});\n\n(0,_getWeatherInfo__WEBPACK_IMPORTED_MODULE_1__.getWeatherInfo)('reno', 'imperial');\n(0,_getForecast__WEBPACK_IMPORTED_MODULE_0__.getForecast)('reno', 'imperial')\n\n//# sourceURL=webpack://weatherapp/./src/index.js?");
...
eval("module.exports = __webpack_require__.p + \"cbe4a2500a10d90bef1a.png\";\n\n//# sourceURL=webpack://weatherapp/./src/weather_icons/sunrise.png?");
...
eval("module.exports = __webpack_require__.p + \"c68d0b4b27127a93ddd4.png\";\n\n//# sourceURL=webpack://weatherapp/./src/weather_icons/sunset.png?");
...
/***/ "./src/weather_icons/verticle_line.png":
/*!*********************************************!*\
  !*** ./src/weather_icons/verticle_line.png ***!
  \*********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"70e184163d027fb13306.png\";\n\n//# sourceURL=webpack://weatherapp/./src/weather_icons/verticle_line.png?");
